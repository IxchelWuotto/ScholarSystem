...
<div class="container">
        ...
        <h5>Por favor, seleccione el grupo del que quiere ver sus alumnos:</h5>
      </div>
    </div>
<div class="container">
<?php
...
<form role="form" method="post" id="form1" name="form1" action="index.php?p=alumnos_por_grupo" >
...
<p></p>
<form role="form" method="post" id="form1" name="form1" action="index.php?p=res_alumnos_por_grupo" >
...
<div class="form-group">
 ...
 <label for="materias">Escoja el grupo para listar los alumnos</label><br>
...
<div class="form-group">
 ...
 <label for="id_periodo">Escoja el periodo para tomar asistencia</label><br>
