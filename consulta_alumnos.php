<div class="jumbotron">
      <div class="container">
        ...
        <h5>Por favor, llene los siguientes campos necesarios para consultar los datos del alumno:</h5>
      </div>
    </div>
    
<div class="container">
<form role="form" method="post" id="form1" name="form1" action="index.php?p=crud&operacion=4" >
