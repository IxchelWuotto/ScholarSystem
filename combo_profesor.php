...
$menu_sql = mysql_query("SELECT * FROM profesor"); //Selecciona los titulos del menu
if ( mysql_num_rows($menu_sql) > 0) //si la variable tiene al menos 1 fila entonces seguimos con el codigo
{
    ...
    {
        $combobit .=" <option value='".$menu['0']."'>".$menu['2']." ".$menu['3']." ".$menu['4']."</option>"; //concatenamos el los options para luego ser insertado en el HTML
    }
}
else
{
