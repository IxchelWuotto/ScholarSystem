...
<form role="form" method="post" id="form1" name="form1" action="index.php?p=reporte_calificaciones" >
...
<p></p>
<form role="form" method="post" id="form1" name="form1" action="index.php?p=res_reporte_calificaciones" >
...
<div class="form-group">
 ...
 <label for="materias">Escoja el grupo para consultar el reporte de calificaciones</label><br>
