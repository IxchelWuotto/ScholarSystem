...
<div class="jumbotron">
<div class="container">
        <h2>Asistencia por grupos</h2>
        <h5>Por favor, seleccione el grupo del cual tomará asistencia.</h5>
      </div>
    </div>
<div class="container">
<?php
...
<form role="form" method="post" id="form1" name="form1" action="index.php?p=asistencia_por_grupo" >
...
<div class="form-group">
 ...
 <label for="materias">Escoja el grupo para tomar asistencia</label><br>
